    ...
    <div class="back">
        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <g id="Back">
                ...
                <g class="st8">
                    <text transform="matrix(1 0 0 1 624.083 280.0879)" class="st9 st6 st10">CVC</text>
                </g>
                <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">{{ nameBack.substring(0,30) }}</text>
            </g>
        </svg>
    </div>
</template>
